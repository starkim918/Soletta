...
        life_status = 0;
		switch (room) {
			case rm_space_lvl1:
			case rm_ship_lvl1:
			case rm_outdoors_lvl1:
			case rm_enemy_base_lvl1:
			case rm_vent_puzzle:
				room_goto(rm_gameover_lvl1);
				break;
			//case rm_friend_ship_lvl2:
			case rm_ship_lvl2:
			case rm_enemy_base_lvl2:
			    room_goto(rm_gameover_lvl2);
				break;
			case rm_ship_lvl3:
			case rm_enemyship_lvl3:
				room_goto(rm_gameover_lvl3);
				break;
			default:
			    room_goto(rm_intro);
		}
